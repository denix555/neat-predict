...
################################### DATA ######################################
    ...
    g = [[2, 0], [2, 1], [1, 0], [3, 1], [4, 0], [1, 0], [5, 1], [3, 0], [2, 1], [2, 0], [2, 1], [2, 1], [4, 0], [2, 0], [2, 1], [4, 0]]
...
################################## PREPARE ##################################
    ...
    if klines:
        ...
        for i in range(-len_d,0):
            ...
            k['rsi7'] = rsi([klines[x]['close'] for x in range(i-rsi7,i)])
            k['cci7'] = cci([sum([klines[x]['high'],klines[x]['low'],klines[x]['close']]) / 3 for x in range(i-cci7,i)])
            cho_3 = sum([cho(klines[x]['high'],klines[x]['low'],klines[x]['close'],klines[x]['volume']) for x in range(i-cho3,i)]) / cho3
            cho_10 = sum([cho(klines[x]['high'],klines[x]['low'],klines[x]['close'],klines[x]['volume']) for x in range(i-cho10,i)]) / cho10
