...
filename = 'log_test3e.txt'
os.system("cat /dev/null > log_test3e.txt")
...
################################## PREPARE ##################################
    ...
    for i in range(len_klines):
        ...
        if i >= len_cho10:
            ...
            c_cho = cho(klines[i-1][4],klines[i-1][3],klines[i-1][2],klines[i-1][1])
...
################################# END FUNCTION #################################
    ...
    g = [[3, 0], [2, 0], [3, 1], [2, 1], [3, 0], [1, 1], [2, 0], [4, 1], [3, 1], [1, 1], [2, 0], [2, 0], [5, 1], [3, 0], [2, 0], [4, 0], 18]
...
################################### TRADE #####################################
        ...
        if not buy:
            ...
            if comp('r7',g[0][0],g[0][1],d) and \
               comp('c31',g[1][0],g[1][1],d) and \
               (comp('s',g[2][0],g[2][1],d) or \
               comp('c7',g[3][0],g[3][1],d)): 
                ...
                action = True
                 ...
                 (comp('r7',g[6][0],g[6][1],d) or \
                 comp('c7',g[7][0],g[7][1],d)): 
            ...
            if comp('r7',g[8][0],g[8][1],d) and \
               comp('c31',g[9][0],g[9][1],d) and \
               (comp('s',g[10][0],g[10][1],d) or \
            ...
            if action:
                percent1 = ((d[-1]['s'] - buy_price1) * 100 / buy_price1) - 0.2
                profit1 += percent1
